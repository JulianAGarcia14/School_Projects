...
/**
 * Handles checking for if the game is won
...
public class GomokuAi implements GoPlayer {
    ...
    /**
     * Determines the next move of the ai, simply finds first open space on board, unused in this project
